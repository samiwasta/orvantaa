      ...
      >
        ...
        {showCloseButton ? (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-md opacity-60 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-none"
          >
